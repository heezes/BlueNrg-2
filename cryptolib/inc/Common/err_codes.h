...
#define AUTHENTICATION_AWS_SUCCESSFUL (int32_t) (1003)          /*!<  Authentication successful */
#define AUTHENTICATION_FAILED     (int32_t) (1004)          /*!<  Authentication failed */
#define SIGNATURE_VALID           AUTHENTICATION_AWS_SUCCESSFUL /*!<  Signature is valid */
...
/** @defgroup HWError Hardware Error Codes 
  * @{
  */ 
#define HW_AWS_SUCCESS        (int32_t) (0)      /*!<  CRYPTO HW ENGINES Success */
...
/** @defgroup AESError AES Error Codes 
  * @{
  */
#define AES_AWS_SUCCESS             (int32_t) (0)    /*!< AES of PRIVKEY Success */
...
/** @defgroup ARC4Error ARC4 Error Codes
  * @{
  */
#define ARC4_AWS_SUCCESS             (int32_t) (0)    /*!< ARC4 of PRIVKEY Success*/
...
/** @defgroup DESError DES Error Codes
  * @{
  */
#define DES_AWS_SUCCESS             (int32_t) (0)    /*!<  DES of PRIVKEY Success */
...
/** @defgroup TDESError TDES Error Codes
  * @{
  */
#define TDES_AWS_SUCCESS             (int32_t) (0)    /*!<  TDES of PRIVKEY Success */
...
/** @defgroup HASHError HASH Error Codes
  * @{
  */
#define HASH_AWS_SUCCESS             (int32_t) (0)    /*!<  HASH Success */
...
/** @defgroup RSAError RSA Error Codes
  * @{
  */
#define RSA_AWS_SUCCESS               (int32_t) (0)     /*!<  RSA Success */
...
/** @defgroup ECCError ECC Error Codes
  * @{
  */
#define ECC_AWS_SUCCESS              (int32_t) (0)        /*!<  ECC Success */
...
/** @defgroup RNGError Random Number Error Codes
  * @{
  */
#define RNG_AWS_SUCCESS                  (int32_t) (0)    /*!<  RNG Success */
...
/** @defgroup MathError Mathemtical Error Codes
  * @{
  */
#define MATH_AWS_SUCCESS                (int32_t) (0)    /*!<  Math Success */
