...
/* Number of attributes requests from the test demo */
#define NUM_APP_GATT_ATTRIBUTES	(37)
...
#define MAX_NUMBER_ATTRIBUTE_SERVICE1	(26)
...
#define ATT_VALUE_ARRAY_SIZE	(414 + OTA_ATT_VALUE_ARRAY_SIZE)
