...
/* Number of services requests from the bms demo */
#define NUM_APP_GATT_SERVICES	(2)

/* Number of attributes requests from the bms demo */
#define NUM_APP_GATT_ATTRIBUTES	(36)
...
#define BMS_MAX_ATT_SIZE	(61)
#define APP_MAX_ATT_SIZE	  MAX_CHAR_LEN(OTA_MAX_ATT_SIZE,  BMS_MAX_ATT_SIZE)

/* Number of links needed for the bms demo: 1 */
...
#define MAX_NUMBER_ATTRIBUTE_SERVICE1	(25)

/* Max Number of Attribute Records defined for the service:
Please make sure this value is used for configuring the related aci_gatt_add_service(), Max_Attribute_Records parameter  value */
#define MAX_NUMBER_ATTRIBUTE_SERVICE2	(13)

/* Number of characteristics defined by the user application */
/*#define NUMBER_CHAR_SERVICE1	(8)
#define NUMBER_CHAR_SERVICE2	(4)
*/
/* Number of GATT attributes needed for the bms demo */
#define NUM_GATT_ATTRIBUTES	(DEFAULT_NUM_GATT_ATTRIBUTES + NUM_APP_GATT_ATTRIBUTES)

/* Number of GATT services needed for the bms demo */
...
#define ATT_VALUE_ARRAY_SIZE	(851 + OTA_ATT_VALUE_ARRAY_SIZE)
